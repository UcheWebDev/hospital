    ...
    <section id="main-content" class="admin-dashboard">
      <div class="container-fluid">
        <div class="main-content-header">
          ...
          <span class="white">Welcome to Accountancy Dashboard</span>
        </div>
        <b-modal id="approve-appointment" title="">
          <div class="modal-body-wrapper">
            <div class="successful-message">
              <div class="content-wrapper">
                <i class="fa-solid fa-circle-check"></i>
                <h2>Approved</h2>
                <p class="">Your appointment approved successfully</p>
              </div>
            </div>
          </div>
        </b-modal>
        ...
        <div class="form">
          <div class="form-group">
            <select class="form-control" v-model="form.status">
              ...
              <option value="Consultancy Paid">Consultancy Paid</option>
...
export default {
  ...
  methods: {
    ...
    updateInfo() {
      this.isLoading = true;
      AccountUpadateAppointmentRecord(this.form)
        .then((response) => {
