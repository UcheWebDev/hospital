      ...
      <section id="main-content" class="admin-dashboard">
        <div class="container-fluid">
          <div class="main-content-header">
            <h2 class="white">Add Accountancy</h2>
            <span class="white">Add new accountancy staff</span>
          </div>
                            ...
                            <div class="form-group">
                              ...
                              >
                                ...
                                <input
                                  type="tel"
                                  class="form-control"
                                  placeholder="Accountant Contact no"
                                  v-model="form.phone"
                                />
                                <span class="validated mt-2 text-danger">{{
                                  errors[0]
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              >
                                ...
                                <textarea
                                  class="form-control"
                                  placeholder="Enter Accountant Home Address"
                                  rows="3"
                                  v-model="form.addr"
                                ></textarea>
                                <span class="validated mt-2 text-danger">{{
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          ...
                          <b-button
                            ...
                            @click.prevent="handleSubmit(AddStaff)"
                          >
                            <span v-if="isLoading">
