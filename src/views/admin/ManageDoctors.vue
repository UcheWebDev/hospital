    ...
    <section id="main-content" class="admin-dashboard">
      <div class="container-fluid">
        <div class="main-content-header">
          <h2 class="white">Manage Staff</h2>
          <span class="white">Manage medical bio informations</span>
        </div>
...
export default {
  ...
  data() {
    return {
      Tablelink: "https://api.seftonhospital.com/api/allmedicalstaffs",
      form: {
        firstname: null,
        lastname: null,
        specialty: "Specialty",
  ...
  methods: {
    ...
    updateItem(e) {
      ...
      this.form.specialty = e.specialization;
      this.form.fee = e.consultancyfee;
    ...
    updateInfo() {
      this.isLoading = true;
      UpdateMedicalStaffRecord(this.form)
        .then((response) => {
    ...
    removeItem(e) {
      const payload = { id: e };
      RemoveMedicalStaffRecord(payload)
        .then((response) => {
          const notyf = new Notyf({
            duration: 4000,
            position: { x: "right", y: "bottom" },
