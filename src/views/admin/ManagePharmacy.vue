<template>
      ...
      <section id="main-content" class="admin-dashboard">
        <div class="container-fluid">
          <div class="main-content-header">
            <h2 class="white">Manage Pharmacist</h2>
            <span class="white">Manage pharmacist bio informations</span>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        Tablelink: "https://api.seftonhospital.com/api/AllPharmacists",
        form: {
          firstname: null,
          lastname: null,
          contact: null,
    ...
    methods: {
      ...
      updateInfo() {
        this.isLoading = true;
        UpdatePharmacyRecord(this.form)
          .then((response) => {
