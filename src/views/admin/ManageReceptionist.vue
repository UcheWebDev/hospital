<template>
      ...
      <section id="main-content" class="admin-dashboard">
        <div class="container-fluid">
          <div class="main-content-header">
            <h2 class="white">Manage Receptionst</h2>
            <span class="white">Manage receptionists bio informations</span>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        Tablelink: "https://api.seftonhospital.com/api/AllReceptionists",
        form: {
          firstname: null,
          lastname: null,
          contact: null,
    ...
    methods: {
      ...
      updateInfo() {
        this.isLoading = true;
        UpdateReceptionistRecord(this.form)
          .then((response) => {
      ...
      removeItem(e) {
        console.log(e)
        const payload = { id: e };
        RemoveReceptionistRecord(payload)
          .then((response) => {
            const notyf = new Notyf({
              duration: 4000,
              position: { x: "right", y: "bottom" },
